...
namespace PeterO {
  ...
  public interface IWriter : IByteWriter {
    ...
    /// <exception cref='System.ArgumentNullException'>Should be thrown if
    /// the parameter "bytes" is null.</exception>
    /// <exception cref='System.ArgumentException'>Should be thrown if
    /// either "offset" or "length" is less than 0 or greater than "bytes"
    /// 's length, or "bytes" 's length minus "offset" is less than
    /// "length".</exception>
