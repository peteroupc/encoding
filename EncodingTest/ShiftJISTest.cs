...
namespace EncodingTest {
  ...
  public class ShiftJISTest {
    ...
    public void TestShiftJISDecoder() {
      ...
      bytes = new byte[] {
        0x72, 0x4b, 0x32, 0x2a, (byte)0xa2, (byte)0xab, 0x51,
        (byte)0xb4, 0x27,
      };
      str = "rK2*\uff62\uff6bQ\uff74'";
      Assert.AreEqual(
      ...
      bytes = new byte[] {
        (byte)0xb6, (byte)0xd2, 0x7d, 0x48, 0x53, 0x31, 0x1f,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x78, 0x77, 0x4d, 0x51, (byte)0xed, (byte)0xab,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x44, 0x79, 0x74, 0x1e, 0x02, 0x1e, 0x48, 0x79,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x20, 0x29, (byte)0xde, 0x60, 0x78, (byte)0xda, 0x34,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xb3, (byte)0xbd, (byte)0x9f, (byte)0xb6, 0x5c,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x2c, (byte)0x87, 0x30, 0x6b, (byte)0x90, 0x27, 0x1a,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x0b, 0x19, 0x6d, 0x7f, 0x11, (byte)0xa8, (byte)0xaf,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x44, 0x46, 0x32, 0x55, (byte)0xb3, (byte)0xf1, 0x47,
        0x57, 0x08, (byte)0xfd, 0x59, 0x61, 0x0d, 0x5d, (byte)0x9f,
        (byte)0x9e,
      };
      str = "DF2U\uff73\ue0c3W\u0008\ufffdYa\r]\u6cbe";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x8e, (byte)0xa3, 0x03, 0x5e, 0x4f, 0x4c, 0x78,
        0x4a,
      };
      str = "\u74bd\u0003^OLxJ";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x63, 0x5f, 0x70, (byte)0xea, (byte)0xed, 0x4c,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xc1, 0x68, 0x38, (byte)0xb6, (byte)0x8f, 0x21,
        0x72, 0x63, 0x56, 0x35,
      };
      str = "\uff81h8\uff76\ufffd!rcV5";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x4a, (byte)0x9e, (byte)0xd4, (byte)0xfe, 0x76, 0x4b,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x8d, (byte)0xac, 0x7d, (byte)0xa2, 0x5a,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x53, 0x74, (byte)0x89, (byte)0xc7, 0x25, 0x74, 0x24,
        (byte)0x81, 0x1c, 0x35,
      };
      str = "St\u5be1%t$\ufffd\u001c5";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x51, 0x56, 0x5c, 0x5d, (byte)0xe8, (byte)0xc0, 0x67,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xfc, 0x31, (byte)0x88, (byte)0x84, 0x34, 0x79,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x62, (byte)0xb3, 0x76, 0x1b, 0x27, (byte)0xe1, 0x6c,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x5d, 0x46, (byte)0x80, 0x20, (byte)0xcc,
        (byte)0xe4,
      };
      str = "]F\u0080\u0020\uff8c\ufffd";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x23, 0x7b, (byte)0xc9, (byte)0xc3, (byte)0xdf, 0x30,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x6b, 0x5d, (byte)0xce, 0x3e, (byte)0xde, (byte)0xc1,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x70, (byte)0xbc, (byte)0xb4, 0x58, (byte)0x98, 0x6a,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x4a, 0x58, (byte)0x94, 0x03, (byte)0xe7, 0x1e, 0x01,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x27, (byte)0xb7, 0x14, 0x55, 0x45, 0x64, 0x39, 0x2a,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x08, 0x2d, (byte)0xee, 0x32, 0x5d, (byte)0xa0,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xe9, 0x3a, 0x1f, (byte)0xae, 0x72, (byte)0xea,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xed, 0x2a, 0x38, 0x6d, 0x36, (byte)0xda, 0x50,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xbb, 0x6d, (byte)0xe5, (byte)0xae, (byte)0xa2,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xef, (byte)0x9b, (byte)0x91, 0x7e, (byte)0x8e,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xc2, (byte)0x92, 0x3a, (byte)0x96, 0x5e, 0x4e,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x8c, (byte)0xc0, (byte)0xee, (byte)0xc5,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x61, 0x2d, (byte)0xbb, (byte)0x9b, 0x70, (byte)0xb9,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x03, 0x6e, (byte)0xa1, 0x78, (byte)0xac, 0x2f, 0x24,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x63, 0x28, (byte)0xf0, (byte)0xe3, 0x53, 0x25, 0x04,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x91, (byte)0xab, 0x3c, (byte)0xf8, 0x16,
        (byte)0x9d, 0x41, 0x3a,
      };
      str = "\u8db3<\ufffd\u0016\u6221:";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xeb, 0x52, (byte)0x8b, (byte)0xa6, (byte)0xac,
        (byte)0x9c,
      };
      str = "\ufffdR\u5354\uff6c\ufffd";
      Assert.AreEqual(
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xc9, 0x23, 0x6b, 0x37, 0x28, 0x61, 0x72, 0x38,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x70, (byte)0x98, (byte)0xba, (byte)0xde, (byte)0xb0,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x1e, 0x64, 0x26, 0x15, (byte)0xf0, 0x3f, 0x71, 0x5b,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x71, 0x40, 0x2d, 0x42, 0x21, 0x6e, (byte)0xd1, 0x57,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x0b, 0x23, (byte)0xbc, (byte)0xd6, (byte)0x8d,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x55, 0x7b, 0x21, (byte)0xdd, 0x02, 0x7d, 0x11, 0x7e,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x68, 0x75, 0x6f, 0x38, 0x00, (byte)0x8b, 0x44,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x95, (byte)0xd7, 0x2d, 0x46, 0x38, (byte)0xb0,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x70, 0x5d, (byte)0xc9, 0x3f, (byte)0x84, (byte)0xdb,
        (byte)0xbb, 0x61, (byte)0xa5, 0x63, 0x3b, 0x61, (byte)0xc9,
        (byte)0x83,
      };
      str = "p]\uff89?\ufffd\uff7ba\uff65c;a\uff89\ufffd";
      Assert.AreEqual(
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x3f, 0x65, 0x39, 0x7e, 0x39, (byte)0xb5, (byte)0x9f,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x91, 0x67, (byte)0xa1, 0x01, 0x09, 0x49, 0x49,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x36, 0x27, 0x79, (byte)0xbf, 0x6d, 0x30, 0x5c,
        (byte)0xaf,
      };
      str = "6'y\uff7fm0\\\uff6f";
      Assert.AreEqual(
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xa8, (byte)0x8f, (byte)0xa1, (byte)0xc2, 0x79,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x49, 0x47, 0x2a, 0x6d, 0x51, 0x71, (byte)0xb1, 0x28,
        0x52,
      };
      str = "IG*mQq\uff71(R";
      Assert.AreEqual(
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x83, 0x4c, 0x0b, 0x58, (byte)0xd2, (byte)0xd9,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xf7, (byte)0xfe, 0x21, 0x6c, (byte)0xf2,
        0x2c,
      };
      str = "\ufffd!l\ufffd\u002c";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xa5, 0x4f, 0x3b, 0x4e, 0x5a, (byte)0xdd, 0x5b,
        (byte)0xbf, 0x00, (byte)0x80, (byte)0x94, 0x3f, 0x39, 0x23, 0x49,
        (byte)0x8d, (byte)0x91, 0x3b, 0x37, (byte)0xcd, (byte)0xbe,
        (byte)0xf4,
      };
      str =
        "\uff65O;NZ\uff9d[\uff7f\u0000\u0080\ufffd?9#I\u56fd;7\uff8d\uff7e\ufffd";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x30, 0x00, 0x39, 0x16, 0x06, (byte)0xab, (byte)0x8a,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x5e, (byte)0x98, (byte)0xce, 0x38, 0x6b, 0x1c,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x9c, (byte)0xa0, 0x48, 0x73, 0x66, (byte)0xd1,
        0x79,
      };
      str = "\u609bHsf\uff91y";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x4f, (byte)0x95, (byte)0xf3, (byte)0x88, 0x70,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x17, (byte)0xa8, 0x40, 0x65, 0x2f, 0x50, (byte)0xad,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x26, 0x47, 0x75, (byte)0xb6, (byte)0xbb, (byte)0xba,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xab, 0x75, 0x63, 0x5c, 0x79, (byte)0xf3, 0x31,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x9c, 0x13, 0x51, 0x5d, 0x6c, 0x3a, 0x4d, 0x56,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x56, (byte)0xce, 0x2c, (byte)0xa7, (byte)0x8e, 0x30,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x1f, (byte)0xe6, (byte)0xf8, 0x7b, 0x3b, 0x0f, 0x4a,
        (byte)0x97,
      };
      str = "\u001f\u8e42\u007b;\u000fJ\ufffd";
      Assert.AreEqual(
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x95, 0x19, (byte)0xd1, (byte)0xdf, 0x55,
        (byte)0x88, 0x18,
      };
      str = "\ufffd\u0019\uff91\uff9fU\ufffd\u0018";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x38, 0x6f, 0x2c, (byte)0x97, 0x16, (byte)0xb8, 0x7c,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x08, 0x63, 0x51, (byte)0xad, 0x77, (byte)0x84,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xb1, (byte)0xf1, 0x7f, 0x2d, 0x6e, (byte)0xdf,
        (byte)0xbd, (byte)0xef, (byte)0xd0, (byte)0x80, (byte)0x8b, (byte)0xcd,
        0x12, 0x4b, 0x77, 0x06, (byte)0xed, (byte)0xdb, 0x0c, (byte)0x82,
        0x72,
      };
      str =
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x28, 0x2b, (byte)0xb1, 0x2a, 0x45, (byte)0x87, 0x53,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xf2, 0x29, (byte)0xa0, 0x31, (byte)0xf3,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x0c, 0x38, (byte)0xcb, (byte)0xc2, (byte)0x9c,
        (byte)0xce, (byte)0xbc,
      };
      str = "\u000c8\uff8b\uff82\u615a\uff7c";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x83, 0x45, (byte)0xfb, (byte)0xca, 0x6d,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xe2, (byte)0x84, 0x56, (byte)0xf3, 0x25,
        (byte)0xad,
      };
      str = "\u9083V\ufffd%\uff6d";
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x7e, 0x76, 0x05, (byte)0x95, (byte)0xc3, 0x38,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xb8, (byte)0xdd, (byte)0xc8, 0x13, (byte)0xf5,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x54, (byte)0xe1, (byte)0xc0, 0x4d, 0x74, 0x06,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x51, (byte)0x92, (byte)0x99, 0x12, 0x24, 0x00, 0x20,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x99, (byte)0xe5, 0x1d, (byte)0xb5, (byte)0xd6,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x67, 0x52, (byte)0xe6, 0x7e, 0x59, 0x4f, 0x4e, 0x56,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x18, (byte)0xf5, (byte)0xac, 0x2c, 0x57, 0x26, 0x40,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x18, (byte)0xc5, 0x04, 0x32, 0x56, 0x53, 0x59,
      ...
      Assert.AreEqual(
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x13, (byte)0xd1, (byte)0xc3, 0x66, 0x49, (byte)0xe5,
    ...
    public void TestShiftJISEncoder() {
      ...
      str = "\uff67\u8eeb\uff25\u542e";
      bytes = new byte[] {
        (byte)0xa7, (byte)0xe7, 0x66, (byte)0x82, 0x64,
        (byte)0x99, (byte)0xe2,
      };
      ...
      str = "\u6c92\u829f\u7a18\uff2f\uff3d";
      bytes = new byte[] {
        (byte)0x9f, (byte)0x93, (byte)0xe4, (byte)0x8c,
      ...
      str = "\uff95\uff26\u59bb";
      bytes = new byte[] {
        (byte)0xd5, (byte)0x82, 0x65, (byte)0x8d,
        (byte)0xc8,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u6e07\u7ddc\uff1b";
      bytes = new byte[] {
        (byte)0x8a, (byte)0x89, (byte)0xe3, 0x63, (byte)0x81,
        0x47,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uffe2\u59c9\u7e3d";
      bytes = new byte[] {
        (byte)0x81, (byte)0xca, (byte)0x8e, 0x6f, (byte)0xe3,
        0x60,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff3e\uff98\u2252";
      bytes = new byte[] {
        (byte)0x81, 0x4f, (byte)0xd8, (byte)0x81,
        (byte)0xe0,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff61\u5ff5\u624e\u2211";
      bytes = new byte[] {
        (byte)0xa1, (byte)0x94, 0x4f, (byte)0x9d, 0x48,
        (byte)0x87, (byte)0x94,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u71ee\u5230\u5d18\u6e6f";
      bytes = new byte[] {
        (byte)0x99, (byte)0xd7, (byte)0x93, (byte)0x9e,
      ...
      str = "\uff03\u7b1b\uff5a\uffe2\u0014\u8b26";
      bytes = new byte[] {
        (byte)0x81, (byte)0x94, (byte)0x93, 0x4a, (byte)0x82,
      ...
      str = "\u22bf\uff03\u73d6";
      bytes = new byte[] {
        (byte)0x87, (byte)0x99, (byte)0x81, (byte)0x94,
        (byte)0xfb, 0x62,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u5147\uff79\uff83\uff85";
      bytes = new byte[] {
        (byte)0x8b, (byte)0xa2, (byte)0xb9, (byte)0xc3,
        (byte)0xc5,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u51b5\u5acc\uff66";
      bytes = new byte[] {
        (byte)0x99, 0x76, (byte)0x8c, (byte)0x99,
        (byte)0xa6,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff9c\u6bcd\u742a\u5abd";
      bytes = new byte[] {
        (byte)0xdc, (byte)0x95, (byte)0xea, (byte)0xfb, 0x68,
        (byte)0x9b, 0x5f,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u30d9\uff24\u7be0\u5c39";
      bytes = new byte[] {
        (byte)0x83, 0x78, (byte)0x82, 0x63, (byte)0x8e,
      ...
      str = "\u7296\u628a\uff3b\uff91";
      bytes = new byte[] {
        (byte)0xe0, (byte)0xb6, (byte)0x94, 0x63, (byte)0x81,
        0x6d, (byte)0xd1,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u75e2\uff5c\uff95\uff0b";
      bytes = new byte[] {
        (byte)0x97, (byte)0x9f, (byte)0x81, 0x62, (byte)0xd5,
        (byte)0x81, 0x7b,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u60da\uff8d\u7d18";
      bytes = new byte[] {
        (byte)0x8d, (byte)0x9b, (byte)0xcd, (byte)0x8d,
        0x68,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff94\u738b\u2534\uffe4";
      bytes = new byte[] {
        (byte)0xd4, (byte)0x89, (byte)0xa4, (byte)0x84,
      ...
      str = "\uffe4\uff36\uff4e";
      bytes = new byte[] {
        (byte)0xfa, 0x55, (byte)0x82, 0x75, (byte)0x82,
        (byte)0x8e,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff7f\u5132\uff3f";
      bytes = new byte[] {
        (byte)0xbf, (byte)0x96, (byte)0xd7, (byte)0x81,
        0x51,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u5df1\uff43\uff73";
      bytes = new byte[] {
        (byte)0x8c, (byte)0xc8, (byte)0x82, (byte)0x83,
        (byte)0xb3,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u7f9a\uff40\uff3e\u5feb\u7977";
      bytes = new byte[] {
        (byte)0xe3, (byte)0xb7, (byte)0x81, 0x4d, (byte)0x81,
      ...
      str = "\u550f\u7bf7\uff58\uff46";
      bytes = new byte[] {
        (byte)0x9a, 0x48, (byte)0xe2, (byte)0xc9, (byte)0x82,
      ...
      str = "\u7737\uff2c\uff22";
      bytes = new byte[] {
        (byte)0xe1, (byte)0xc5, (byte)0x82, 0x6b, (byte)0x82,
        0x61,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u5960\u61b6\u246b";
      bytes = new byte[] {
        (byte)0x9a, (byte)0xf9, (byte)0x89, (byte)0xaf,
        (byte)0x87, 0x4b,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff54\u2234\uff14";
      bytes = new byte[] {
        (byte)0x82, (byte)0x94, (byte)0x81, (byte)0x88,
        (byte)0x82, 0x53,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff54\uff57\uff49";
      bytes = new byte[] {
        (byte)0x82, (byte)0x94, (byte)0x82, (byte)0x97,
        (byte)0x82, (byte)0x89,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff3a\u7b92\uff22\uff6a\u72a7\u7a84";
      bytes = new byte[] {
        (byte)0x82, 0x79, (byte)0xe2, (byte)0xb4, (byte)0x82,
      ...
      str = "\u6de4\u5ef0\uff8f\u78a3";
      bytes = new byte[] {
        (byte)0x9f, (byte)0xc9, (byte)0x9c, 0x4c, (byte)0xcf,
        (byte)0xe1, (byte)0xf0,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u7984\u212b\u5192\u9c24";
      bytes = new byte[] {
        (byte)0x98, 0x5c, (byte)0x81, (byte)0xf0, (byte)0x96,
      ...
      str = ")\uff73\uff86\u76fb";
      bytes = new byte[] {
        0x29, (byte)0xb3, (byte)0xc6, (byte)0xe1,
        (byte)0xbb,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff1c\u61a7\u7d89\u7c4c";
      bytes = new byte[] {
        (byte)0x81, (byte)0x83, (byte)0x93, (byte)0xb2,
      ...
      str = "\uff42\u52d5\uff32";
      bytes = new byte[] {
        (byte)0x82, (byte)0x82, (byte)0x93, (byte)0xae,
        (byte)0x82, 0x71,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff1a\u7c1f\uff8b";
      bytes = new byte[] {
        (byte)0x81, 0x46, (byte)0xe2, (byte)0xd0,
        (byte)0xcb,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u56f0\u574a\uff15";
      bytes = new byte[] {
        (byte)0x8d, (byte)0xa2, (byte)0x96, 0x56, (byte)0x82,
        0x54,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u246f\u777e\u5506\u6703\uff19";
      bytes = new byte[] {
        (byte)0x87, 0x4f, (byte)0xe1, (byte)0xce, (byte)0x8d,
      ...
      str = "\u7e9c\uff20\uff35";
      bytes = new byte[] {
        (byte)0xe3, (byte)0x9c, (byte)0x81, (byte)0x97,
        (byte)0x82, 0x74,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u25c6\uff05\u6bbf";
      bytes = new byte[] {
        (byte)0x81, (byte)0x9f, (byte)0x81, (byte)0x93,
        (byte)0x93, 0x61,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u6e9c\u5c05\uff0c";
      bytes = new byte[] {
        (byte)0x97, (byte)0xad, (byte)0x9b, (byte)0x91,
        (byte)0x81, 0x43,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u254b\u7bb4\uff29";
      bytes = new byte[] {
        (byte)0x84, (byte)0xb4, (byte)0xe2, (byte)0xbc,
        (byte)0x82, 0x68,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u67a1\uffe1\u685f";
      bytes = new byte[] {
        (byte)0x9e, 0x65, (byte)0x81, (byte)0x92, (byte)0x8e,
        0x56,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u5968\u52c0\u668e";
      bytes = new byte[] {
        (byte)0x8f, (byte)0xa7, (byte)0xfa, (byte)0x87,
        (byte)0x9d, (byte)0xf3,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u64da\u6e98\uff2d";
      bytes = new byte[] {
        (byte)0x9d, (byte)0x9f, (byte)0x9f, (byte)0xe3,
        (byte)0x82, 0x6c,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u856d\uffe4\u81a9";
      bytes = new byte[] {
        (byte)0xe5, 0x4a, (byte)0xfa, 0x55, (byte)0xe4,
        0x56,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff23\uff9b\uff33\u61ca";
      bytes = new byte[] {
        (byte)0x82, 0x62, (byte)0xdb, (byte)0x82, 0x72,
        (byte)0x9c, (byte)0xe3,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u753a\u5c22\uff44";
      bytes = new byte[] {
        (byte)0x92, (byte)0xac, (byte)0x9b, (byte)0x97,
        (byte)0x82, (byte)0x84,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u6684\uff0c\u570d";
      bytes = new byte[] {
        (byte)0x9d, (byte)0xf5, (byte)0x81, 0x43, (byte)0x9a,
        (byte)0xa1,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff4e\u8a1d\uff7e";
      bytes = new byte[] {
        (byte)0x82, (byte)0x8e, (byte)0xe6, 0x62,
        (byte)0xbe,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u6083\u6d35\u525b";
      bytes = new byte[] {
        (byte)0x9c, (byte)0x9d, (byte)0x9f, (byte)0xab,
        (byte)0x8d, (byte)0x84,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u6e1b\u542b\u707c";
      bytes = new byte[] {
        (byte)0x8c, (byte)0xb8, (byte)0x8a, (byte)0xdc,
        (byte)0x8e, (byte)0xdc,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u5b32\u2312\uff9c";
      bytes = new byte[] {
        (byte)0x9b, 0x6a, (byte)0x81, (byte)0xdc,
        (byte)0xdc,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\u222c\uff39\uff7e";
      bytes = new byte[] {
        (byte)0x81, (byte)0xe8, (byte)0x82, 0x78,
        (byte)0xbe,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
      ...
      str = "\uff9d\u52fa\uff08";
      bytes = new byte[] {
        (byte)0xdd, (byte)0x8e, (byte)0xd9, (byte)0x81,
        0x69,
      };
      TestCommon.AssertByteArraysEqual(
        bytes,
