...
Contains methods for converting text from one character encoding to another.
 ...
 such characters is also called an <i> abstract character repertoire
 </i>.) </li> <li>A <b>coded character set</b> is a set of code
 points which are each assigned to a single text character. As used
 here, coded character sets don't define how code points are laid out
 in memory. </li> <li>A <b>character encoding</b> is a mapping from a
 sequence of code points, in one or more specific coded character
 sets, to a sequence of bytes and vice versa. (For brevity, the rest
 of this documentation may use the term <i> encoding </i> instead.
 RFC 6365 uses the analogous term <i> charset </i> instead; in this
 documentation, however, <i> charset </i> is used only to refer to
 the names that identify a character encoding.) </li>
 <li><b>ASCII</b> is a 128-code-point coded character set that
 ...
 the code points within the Basic Latin block (0-127 or U + 0000 to
 U + 007F) of the Unicode Standard. </li> </ul> <p>There are several
 ...
 and 4 bytes for supplementary code points. </li> <li>(b)
 <code>UTF-8</code> is another encoding defined in the Unicode Standard. It
 uses 1 byte for ASCII and 2 to 4 bytes for the other Unicode code
 points. </li> <li>(c) Most legacy East Asian encodings, such as
 <code>Shift_JIS</code> , <code>GBK</code> , and <code>Big5</code> use 1 byte for ASCII
 (or a slightly modified version) and, usually, 2 or more bytes for
 national standard coded character sets. In many of these encodings,
 notably <code>Shift_JIS</code> , characters whose code points use one byte
 ...
 (with ASCII as the default). </li> <li>(b) UTF-7 (not included in
 the Encoding Standard) is an encoding that uses the Unicode
 ...
 encoding names, such as <code>hz-gb-2312</code>. </li> </ul>
 ...
 class implements the <code>ICharacterDecoder</code> interface. </li>
 <li>An <b>encoding class</b> allows access to both an encoder class
 and a decoder class and implements the <code>ICharacterEncoding</code>
 ...
 formats. </li> <li>A modified version of UTF-7 used in the IMAP
 email protocol. </li> </ul> <p>(Note that this library doesn't
...
* `static ICharacterEncoding UTF8`<br>
 ...
 each code point in the universal coded character set using 1 to 4
 bytes.

## Methods

* `static java.lang.String DecodeToString​(ICharacterEncoding enc,
              byte[] bytes)`<br>
...
* `static java.lang.String DecodeToString​(ICharacterEncoding encoding,
...
* `static void EncodeToWriter​(ICharacterInput input,
              ICharacterEncoder encoder,
              java.io.OutputStream output)`<br>
 Reads Unicode characters from a character input and writes them to a byte
 array encoded in a given character encoding.
* `static void EncodeToWriter​(ICharacterInput input,
...
* `static void EncodeToWriter​(ICharacterInput input,
 ...
 Reads Unicode characters from a character input and writes them to a byte
 array encoded using the given character encoder.
* `static void EncodeToWriter​(java.lang.String str,
              ICharacterEncoding enc,
              IWriter writer)`<br>
...
* `static ICharacterEncoding GetEncoding​(java.lang.String name)`<br>
 Returns a character encoding from the given name.
* `static ICharacterEncoding GetEncoding​(java.lang.String name,
           boolean forEmail)`<br>
 Returns a character encoding from the given name.
* `static ICharacterEncoding GetEncoding​(java.lang.String name,
           boolean forEmail,
 ...
 Returns a character encoding from the given name.
* `static java.lang.String InputToString​(ICharacterInput reader)`<br>
 Reads Unicode characters from a character input and converts them to a text
 string.
* `static java.lang.String ResolveAlias​(java.lang.String name)`<br>
 Resolves a character encoding's name to a standard form.
* `static java.lang.String ResolveAliasForEmail​(java.lang.String name)`<br>
...
* `static byte[] StringToBytes​(ICharacterEncoding encoding,
 ...
 encoding.
* `static ICharacterInput StringToInput​(java.lang.String str)`<br>
 Converts a text string to a character input.
* `static ICharacterInput StringToInput​(java.lang.String str,
             int offset,
             int length)`<br>
...
### DecodeToString
    public static java.lang.String DecodeToString​(ICharacterEncoding encoding, IByteReader input)
Reads bytes from a data source and converts the bytes from a given encoding
...
* <code>java.lang.NullPointerException</code> - The parameter <code>encoding</code> or
 <code>input</code> is null.

### DecodeToString
    public static java.lang.String DecodeToString​(ICharacterEncoding enc, java.io.InputStream input)
Decodes data read from a data stream into a text string in the given
...
* <code>java.lang.NullPointerException</code> - The parameter "encoding" or <code>
 input</code> is null.
...
### DecodeToString
    public static java.lang.String DecodeToString​(ICharacterEncoding enc, byte[] bytes, int offset, int length)
Reads a portion of a byte array from a data source and converts the bytes
...
Reads Unicode characters from a character input and writes them to a byte
 ...
 follows: <code>input.EncodeToBytes(encoding)</code>. If the object's
...
* <code>java.lang.NullPointerException</code> - The parameter <code>encoding</code> is null.
...
* <code>java.lang.NullPointerException</code> - The parameter <code>encoder</code> or <code>
 input</code> is null.
...
### EncodeToBytes
    public static byte[] EncodeToBytes​(java.lang.String str, ICharacterEncoding enc)
Reads Unicode characters from a text string and writes them to a byte array
 ...
 as follows: <code>str.EncodeToBytes(enc)</code>. If the object's class
...
### EncodeToBytes
    public static byte[] EncodeToBytes​(java.lang.String str, ICharacterEncoding enc, boolean htmlFallback)
Reads Unicode characters from a text string and writes them to a byte array
 encoded in a given character encoding and using the given encoder
...
### EncodeToWriter
    public static void EncodeToWriter​(ICharacterInput input, ICharacterEncoding encoding, java.io.OutputStream output) throws java.io.IOException
Reads Unicode characters from a character input and writes them to a byte
 array encoded using the given character encoder. When writing to the
 byte array, any characters that can't be encoded are replaced with
 the byte 0x3f (the question mark character). <p>In the.getNET()
...
### EncodeToWriter
    public static void EncodeToWriter​(ICharacterInput input, ICharacterEncoder encoder, java.io.OutputStream output) throws java.io.IOException
Reads Unicode characters from a character input and writes them to a byte
 array encoded in a given character encoding. When writing to the
 byte array, any characters that can't be encoded are replaced with
 the byte 0x3f (the question mark character). <p>In the.getNET()
...
### GetDecoderInput
    public static ICharacterInput GetDecoderInput​(ICharacterEncoding encoding, java.io.InputStream input)
Converts a character encoding into a character input stream, given a data
...
### GetDecoderInputSkipBom
    public static ICharacterInput GetDecoderInputSkipBom​(ICharacterEncoding encoding, java.io.InputStream input)
Converts a character encoding into a character input stream, given a
...
### GetEncoding
    public static ICharacterEncoding GetEncoding​(java.lang.String name)
Returns a character encoding from the given name.
...
### GetEncoding
    public static ICharacterEncoding GetEncoding​(java.lang.String name, boolean forEmail, boolean allowReplacement)
Returns a character encoding from the given name.
...
### GetEncoding
    public static ICharacterEncoding GetEncoding​(java.lang.String name, boolean forEmail)
Returns a character encoding from the given name.
...
### InputToString
    public static java.lang.String InputToString​(ICharacterInput reader)
Reads Unicode characters from a character input and converts them to a text
...
### ResolveAlias
    public static java.lang.String ResolveAlias​(java.lang.String name)
...
* <code>name</code> - A string that names a given character encoding. Can be null. Any
 ...
 UTF-16 little-endian (16-bit UCS) </li> <li> <code>UTF-16BE</code> -
 UTF-16 big-endian (16-bit UCS) </li> <li>The special-purpose
 encoding <code>x-user-defined</code> </li> <li>The special-purpose
 encoding <code>replacement</code> . </li> <li>28 legacy single-byte
 encodings: <ul> <li> <code>windows-1252</code> : Western Europe (Note: The
 Encoding Standard aliases the names <code>US-ASCII</code> and <code>
 ISO-8859-1</code> to <code>windows-1252</code> , which uses a different coded
 character set from either; it differs from <code>ISO-8859-1</code> by
 assigning different characters to some bytes from 0x80 to 0x9F. The
 Encoding Standard does this for compatibility with existing Web
 pages.) </li> <li> <code>ISO-8859-2</code> , <code>windows-1250</code> :
 Central Europe </li> <li> <code>ISO-8859-10</code> : Northern Europe </li>
 <li> <code>ISO-8859-4</code> , <code>windows-1257</code> : Baltic </li>
 <li> <code>ISO-8859-13</code> : Estonian </li> <li> <code>ISO-8859-14</code> :
 Celtic </li> <li> <code>ISO-8859-16</code> : Romanian </li> <li> <code>
 ISO-8859-5</code> , <code>IBM-866</code> , <code>KOI8-R</code> , <code>
 ...
 Mac Roman </li> </ul> </li> <li>Three legacy Japanese encodings:
 <code>Shift_JIS</code> , <code>EUC-JP</code> , <code>ISO-2022-JP</code> </li>
 <li>Two legacy simplified Chinese encodings: <code>GBK</code> and <code>
 gb18030</code> </li> <li> <code>Big5</code> : legacy traditional Chinese
 encoding </li> <li> <code>EUC-KR</code> : legacy Korean encoding </li>
 </ul> <p>The <code>UTF-8</code> , <code>UTF-16LE</code> , and <code>UTF-16BE</code>
 encodings don't encode a byte-order mark at the start of the text
 (doing so is not recommended for <code>UTF-8</code> , while in <code>
 UTF-16LE</code> and <code>UTF-16BE</code> , the byte-order mark character
 U + FEFF is treated as an ordinary character, unlike in the UTF-16
 encoding form). The Encoding Standard aliases <code>UTF-16</code> to
  <code>UTF-16LE</code> "to deal with deployed content". </p> .
...
### ResolveAliasForEmail
    public static java.lang.String ResolveAliasForEmail​(java.lang.String name)
Resolves a character encoding's name to a canonical form, using rules more
 suitable for email.
...
* <code>name</code> - A string naming a character encoding. Can be null. Uses a
 ...
 <code>windows-1252</code> as specified in the Encoding Standard. The
 ...
 <code>ascii</code> is an alias. </li> <li> <code>ISO-8859-1</code> - Latin-1
 ...
 <li> <code>UTF-16</code> - UTF-16 without a fixed byte order, rather than
 an alias to <code>UTF-16LE</code> as specified in the Encoding Standard.
 ...
 byte stream is skipped. </li> <li> <code>UTF-7</code> - UTF-7 (7-bit
 universal coded character set). The name <code>unicode-1-1-utf-7</code>
 is not supported and is not treated as an alias to <code>UTF-7</code> ,
 ...
 in Unicode 1.1 and earlier than in Unicode 2.0 and later). </li>
  <li><code>ISO-2022-JP-2</code> - similar to "ISO-2022-JP", except that
...
### StringToInput
    public static ICharacterInput StringToInput​(java.lang.String str)
Converts a text string to a character input. The resulting input can then be
 ...
 extension method to any object implementing string and can be called
 as follows: <code>str.StringToInput()</code>. If the object's class
...
### StringToInput
    public static ICharacterInput StringToInput​(java.lang.String str, int offset, int length)
Converts a portion of a text string to a character input. The resulting
 ...
 this extension method.</p> <p>In the.NET implementation, this method
 is implemented as an extension method to any object implementing
 string and can be called as follows: <code>str.StringToInput(offset,
