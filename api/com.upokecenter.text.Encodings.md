...
* <code>name</code> - A string naming a character encoding. Can be null. Uses a
 ...
 to U + 00FF).</li> <li> <code>UTF-7</code> - UTF-7 (7-bit universal coded
 character set). The name <code>unicode-1-1-utf-7</code> is an alias to
 <code>UTF-7</code>, even though both encodings are defined in different
