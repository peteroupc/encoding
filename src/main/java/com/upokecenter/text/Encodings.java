...
ICharacterInput reader) {
     ...
     * encodings: <ul> <li> {@code windows-1252} : Western Europe (Note: The
     * Encoding Standard aliases the names {@code US-ASCII} and {@code
     ...
     * Central Europe </li> <li> {@code ISO-8859-10} : Northern Europe </li>
     * <li> {@code ISO-8859-4} , {@code windows-1257} : Baltic </li> <li>
     * {@code ISO-8859-13} : Estonian </li> <li> {@code ISO-8859-14} :
     * Celtic </li> <li> {@code ISO-8859-16} : Romanian </li> <li> {@code
     * ISO-8859-5} , {@code IBM-866} , {@code KOI8-R} , {@code windows-1251}
     ...
     * <li> {@code ISO-8859-15} , {@code windows-1254} : Turkish </li> <li>
     * {@code windows-874} : Thai </li> <li> {@code windows-1258} :
     ...
     * UTF-16LE} , and {@code UTF-16BE} encodings don't encode a byte-order
     * mark at the start of the text (doing so is not recommended for {@code
     * UTF-8} , while in {@code UTF-16LE} and {@code UTF-16BE} , the
     ...
     * {@code UTF-16} to {@code UTF-16LE} "to deal with deployed content".
     * </p> .
     ...
     * additional encodings are supported. <ul> <li> {@code US-ASCII} -
     * ASCII single-byte encoding, rather than an alias to {@code
     * windows-1252} as specified in the Encoding Standard. The coded
     ...
     * blocks (0-255 or U + 0000 to U + 00FF). </li> <li> {@code UTF-7} - UTF-7
     * (7-bit universal coded character set). The name {@code
     * unicode-1-1-utf-7} is an alias to {@code UTF-7} , even though both
     ...
     * name {@code iso-2022-jp-2} was also aliased to {@code ISO-2022-JP} ,
