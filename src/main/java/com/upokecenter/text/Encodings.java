...
private Encodings() {
     ...
     * @throws NullPointerException The parameter {@code encoding} or
     * {@code input} is null.
     */
...
ICharacterEncoding encoding,
     ...
     * @throws NullPointerException The parameter "encoding" or {@code
     * input} is null.
     */
    public static String DecodeToString(
...
ICharacterInput reader) {
     ...
     * <li> {@code ISO-8859-4} , {@code windows-1257} : Baltic </li>
     ...
     * </ul> <p>The {@code UTF-8} , {@code UTF-16LE} , and {@code UTF-16BE}
     * encodings don't encode a byte-order mark at the start of the text
     * (doing so is not recommended for {@code UTF-8} , while in {@code
     * UTF-16LE} and {@code UTF-16BE} , the byte-order mark character
...
return aliases;
     ...
     * @throws IllegalArgumentException Either {@code offset} or {@code length} is less
     * than 0 or greater than {@code buffer} 's length, or {@code buffer} '
     * s length minus {@code offset} is less than {@code length}.
     * @throws NullPointerException The parameter {@code buffer} is null.
     * @throws IllegalArgumentException Either "offset" or "length" is less than 0 or
     *  greater than "buffer"'s length, or "buffer"'s length minus "offset"
     *  is less than "length".
     * @throws IllegalArgumentException Either "offset" or "length" is less than 0 or
     *  greater than "buffer"'s length, or "buffer"'s length minus "offset"
     *  is less than "length".
