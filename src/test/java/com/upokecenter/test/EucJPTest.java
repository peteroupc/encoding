...
bytes = new byte[] { 0x7d, (byte)0xed, 0x7b, 0x4c, 0x3b, (byte)0xc7, 0x41,
  (byte)0xca, 0x08, (byte)0xa1, (byte)0xc3, (byte)0xe2, (byte)0xc5 };
str = "}\ufffd\u007bL;\ufffdA\ufffd\u0008\uff5c\u7726";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xc5, 0x33, (byte)0xef, (byte)0x80, 0x03, 0x0b,
  (byte)0x82, 0x50, 0x10 };
str = "\ufffd3\ufffd\u0003\u000b\ufffdP\u0010";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x5a, 0x55, (byte)0xcb, (byte)0x9e, (byte)0xa6,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xa3, 0x5d, 0x2a, 0x0b, 0x6a, (byte)0x8f, 0x21,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xba, 0x73, (byte)0xf3, 0x18, 0x03, 0x66,
  (byte)0xaf, 0x0b, (byte)0xd5, 0x6a, (byte)0xa0, 0x72, (byte)0xc8 };
str = "\ufffds\ufffd\u0018\u0003f\ufffd\u000b\ufffdj\ufffdr\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x52, 0x7c, 0x2f, 0x6a, 0x39, (byte)0xc2, 0x4e, 0x66,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xc0, 0x3c, (byte)0xa4, (byte)0x89, 0x22,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x24, 0x65, 0x70, 0x11, (byte)0xbb, 0x70, 0x32,
  (byte)0xb2, (byte)0xbb, (byte)0xe6 };
str = "$ep\u0011\ufffdp2\u97f3\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x2f, 0x08, (byte)0xe9, (byte)0xb5, (byte)0xd5,
  (byte)0xb8, (byte)0xdd, (byte)0xf4, 0x4c, 0x1f, 0x01, (byte)0xe9, 0x32,
  (byte)0x93, (byte)0x97, (byte)0x9a, (byte)0xe3, 0x62, 0x56, 0x42, 0x13,
  (byte)0x8c, 0x5b, 0x6b, 0x57, 0x2a, (byte)0xbb, 0x28, (byte)0xfe, 0x3e };
str =
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xa5, (byte)0xe8, 0x0e, (byte)0xa6, 0x50, 0x06,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xdc, (byte)0xf8, 0x1d, 0x53, (byte)0x9c,
  (byte)0xce, (byte)0xdb, (byte)0xfd, (byte)0xcc, (byte)0xd7, (byte)0xb4 };
str = "\u6a22\u001dS\ufffd\u9e9f\ufffd\u5f5c";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x2d, 0x70, (byte)0xb9, 0x73, (byte)0x99, (byte)0xcf,
  (byte)0x90, 0x20 };
str = "-p\ufffds\ufffd\ufffd\u0020";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xa2, 0x24, 0x21, 0x5c, (byte)0xe4, 0x74,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x64, (byte)0xc0, 0x27, 0x6d, (byte)0xf6, 0x11, 0x2f,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x20, 0x3f, (byte)0xde, (byte)0x94, 0x26, (byte)0xe9,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x78, 0x18, (byte)0xf7, 0x1e, 0x46, 0x77, 0x21,
  (byte)0x98, 0x2d, 0x52, 0x71, (byte)0xa0 };
str = "x\u0018\ufffd\u001eFw!\ufffd-Rq\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xb4, 0x53, (byte)0x97, 0x64, 0x1c, (byte)0xec,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x01, 0x63, 0x1f, (byte)0xe2, 0x1e, 0x64, 0x74, 0x6d,
  0x3f, (byte)0xd5, 0x26, (byte)0xec, 0x52, (byte)0xa8, 0x78 };
str = "\u0001c\u001f\ufffd\u001edtm?\ufffd&\ufffdR\ufffdx";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x3d, (byte)0xf6, 0x61, 0x41, (byte)0xa8, 0x36, 0x41,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0x91, (byte)0xbc, 0x4e, 0x15, (byte)0xdf,
  (byte)0xf7, (byte)0xf4, 0x5f, 0x58, 0x2a, 0x16, 0x26, 0x05, 0x6d };
str = "\ufffd\ufffdN\u0015\u71c9\ufffd_X*\u0016&\u0005m";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x02, (byte)0xeb, 0x6b, (byte)0xc2, 0x60, 0x30, 0x58,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x51, (byte)0xe0, 0x6b, (byte)0x9e, 0x37, (byte)0x87,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xe4, 0x64, (byte)0xe3, 0x1d, (byte)0xca, 0x77,
  0x5a, (byte)0xb7, 0x55, (byte)0x9a, (byte)0xec, (byte)0xaf, 0x58, 0x60,
  (byte)0xb7, (byte)0x82, 0x5a, 0x28, 0x29, (byte)0x83, 0x59, (byte)0x92,
  0x6a, (byte)0xde, (byte)0xe2, 0x74, 0x7a, (byte)0x8d, 0x0f, (byte)0xf2 };
str =
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x23, (byte)0x83, 0x75, 0x22, 0x33, 0x51, 0x64, 0x12,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x67, 0x4e, (byte)0x97, (byte)0xc6, 0x2e, (byte)0x9e,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x62, (byte)0xca, (byte)0xbd, 0x38, 0x16, 0x21, 0x73,
  0x15 };
str = "b\u58408\u0016!s\u0015";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x6f, (byte)0xc8, 0x4e, 0x13, (byte)0xb8, 0x07, 0x2f,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x60, (byte)0x8f, 0x24, 0x41, (byte)0xb0, (byte)0xdc,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0x80, 0x24, (byte)0xc0, 0x4f, 0x57, 0x52, 0x52 };
str = "\ufffd$\ufffdOWRR";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xf7, (byte)0xe0, (byte)0xf5, 0x1a, (byte)0x91,
  (byte)0xee, 0x6b, (byte)0xa3 };
str = "\ufffd\ufffd\u001a\ufffd\ufffdk\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xdd, 0x7a, 0x7e, (byte)0xb2, 0x7e, (byte)0xd5 };
str = "\ufffdz~\ufffd~\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x47, (byte)0x8f, 0x6e, (byte)0xc3, 0x60, (byte)0xfb };
str = "G\ufffdn\ufffd`\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x23, 0x4b, (byte)0xfb, (byte)0xbe, (byte)0x82,
  (byte)0xaf, 0x72, (byte)0x9a, 0x0a, (byte)0xbe, 0x4b, 0x55, 0x47, 0x0b,
  (byte)0xdf, 0x68, (byte)0xbc, (byte)0x89, (byte)0x89, (byte)0xe8,
  (byte)0xbf, 0x25, 0x75, 0x4f, (byte)0xac, 0x35, 0x43, (byte)0xf2, 0x0d };
str =
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x4b, (byte)0xf0, 0x11, 0x5a, (byte)0x9a, 0x35, 0x03,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xbe, 0x21, (byte)0xff, 0x16, 0x29, (byte)0xed,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x66, 0x37, 0x3a, (byte)0xd9, 0x2b, (byte)0xd2, 0x04,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xf7, (byte)0xa8, (byte)0xb3, 0x3d, (byte)0xa0,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0x9f, (byte)0x9f, 0x40, 0x66, 0x6c, 0x13,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x36, 0x0a, (byte)0xa1, (byte)0xfc, (byte)0xdd,
  (byte)0xdb, 0x27, (byte)0xd0, 0x35, 0x67, 0x26 };
str = "6\n\u25cf\u6bdf'\ufffd5g&";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x37, (byte)0xdc, (byte)0xd3, 0x12, (byte)0xdc, 0x21,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x6c, (byte)0xb8, (byte)0x88, 0x7e, (byte)0xf0,
  (byte)0xb2, (byte)0xe0 };
str = "l\ufffd~\u96b9\ufffd";
Assert.assertEquals(
 str,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xe9, (byte)0xdf, 0x6b, 0x52, (byte)0xae, 0x26,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x04, 0x47, 0x67, 0x6d, 0x62, 0x34, 0x35, 0x6a, 0x79,
  (byte)0xc9, 0x42, (byte)0xa3, 0x3e, (byte)0xef };
str = "\u0004Ggmb45jy\ufffdB\ufffd>\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xe3, (byte)0xff, (byte)0x84, 0x5a, (byte)0xc7 };
str = "\ufffd\ufffdZ\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x41, 0x77, (byte)0xbb, 0x73, (byte)0xf2, (byte)0xd4,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xe2, (byte)0x91, 0x68, (byte)0x89, 0x66, 0x4b,
  0x1d, (byte)0xa3, (byte)0xf2, (byte)0xc7 };
str = "\ufffdh\ufffdfK\u001d\uff52\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x4b, 0x70, 0x0b, 0x01, 0x7e, 0x64, (byte)0x95,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x3f, 0x62, (byte)0xb8, 0x0b, 0x24, 0x2d, (byte)0xfa,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0x94, (byte)0xa0, (byte)0xf5, (byte)0xab, 0x1a,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x3f, 0x76, (byte)0xdc, 0x70, 0x55, (byte)0xd1,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x35, (byte)0xcf, 0x36, (byte)0xa7, (byte)0xb9, 0x73,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x4c, (byte)0xd9, (byte)0x96, 0x31, 0x3c, 0x79, 0x1b,
  0x3d, (byte)0xbe, 0x6a };
str = "L\ufffd1<y\u001b\u003d\ufffdj";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xa7, (byte)0xb9, 0x70, 0x2d, 0x53, (byte)0xba,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x42, 0x01, 0x1b, (byte)0xd6, (byte)0x96, 0x20,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x45, (byte)0xe9, 0x35, (byte)0xab, (byte)0xc6,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x77, 0x2d, 0x43, 0x56, 0x79, (byte)0xc4, 0x46,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x26, 0x42, 0x5a, 0x26, (byte)0x99, (byte)0xb5, 0x19,
  0x7d, 0x66, 0x66, (byte)0xd0, (byte)0xd1, (byte)0x9a };
str = "&BZ&\ufffd\ufffd\u0019}ff\u4f70\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xa6, 0x46, 0x51, (byte)0xbb, (byte)0xcd, 0x7c,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x31, (byte)0xa7, 0x36, 0x6a, 0x2e, 0x4b, (byte)0xe0,
  0x23, (byte)0xf7, 0x5f, 0x52, (byte)0x96, 0x37 };
str = "1\ufffd6j.K\ufffd#\ufffd_R\ufffd7";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x3a, (byte)0xa8, (byte)0x9d, (byte)0xf3, 0x52,
  (byte)0xe9, (byte)0xca, (byte)0xc3, (byte)0xfe, 0x40, (byte)0xf9, 0x76,
  (byte)0xc2, 0x59, (byte)0xe5, 0x09, 0x51, 0x74, 0x19, (byte)0xe8, 0x41 };
str = ":\ufffd\ufffdR\u8654\u5bf5@\ufffdv\ufffdY\ufffd\u0009Qt\u0019\ufffdA";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x38, 0x36, 0x51, (byte)0xc7, 0x2d, 0x02, 0x69, 0x59,
  0x6f, (byte)0xf1, (byte)0xe2 };
str = "86Q\ufffd-\u0002iYo\u9a4d";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x13, (byte)0x83, 0x68, (byte)0xe4, 0x08, 0x36, 0x2b,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xcb, (byte)0xdd, (byte)0xdc, (byte)0xdc, 0x5a,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xc6, 0x69, (byte)0xb0, (byte)0xa5, 0x2c, 0x3e,
  0x0a, (byte)0x9b, 0x12, (byte)0x9e, (byte)0x9d, 0x6a, (byte)0x9e };
str = "\ufffdi\u54c0\u002c>\n\ufffd\u0012\ufffd\ufffdj\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xbb, (byte)0xc3, (byte)0xa0, 0x1d, 0x70, 0x77,
  0x31, 0x31, (byte)0x92 };
str = "\u66ab\ufffd\u001dpw11\ufffd";
Assert.assertEquals(
 str,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xc2, (byte)0xef, 0x22, 0x5e, 0x46, 0x6f, 0x2e,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x4a, 0x34, (byte)0xc2, (byte)0xed, (byte)0xad, 0x6f,
  0x3e, 0x1c, 0x64 };
str = "J4\u7027\ufffdo>\u001cd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xae, 0x4a, 0x57, 0x3e, (byte)0xbb, (byte)0xe7,
  (byte)0x99, (byte)0xe8, 0x7a, (byte)0xa8 };
str = "\ufffdJW>\u7d2b\ufffd\ufffdz\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x37, 0x01, (byte)0xda, 0x5c, 0x5b, (byte)0x9f,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xc9, 0x62, (byte)0xdc, (byte)0xda, 0x21, 0x64,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xe3, 0x76, (byte)0xae, 0x64, 0x37, 0x2a, 0x69,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x7e, (byte)0xf1, (byte)0xd0, 0x52, (byte)0xca,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0x98, (byte)0x8c, (byte)0xa1, (byte)0xd0, 0x18,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x06, (byte)0xf4, (byte)0xb8, 0x4e, 0x67, (byte)0xa6,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0x80, 0x17, (byte)0xce, (byte)0xb9, 0x02,
  (byte)0xce, 0x20, 0x7e, (byte)0xa6, 0x5e };
str = "\ufffd\u0017\u65c5\u0002\ufffd\u0020~\ufffd^";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x2f, 0x41, (byte)0x9a, 0x04, (byte)0xe0, 0x75,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { (byte)0xe7, (byte)0xf4, 0x51, (byte)0xc9, 0x0a, 0x33,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x57, 0x6d, 0x32, 0x3f, 0x78, 0x0b, 0x77, 0x5f,
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x0e, (byte)0x8f, 0x6f, (byte)0x81, 0x63, (byte)0x8c,
  0x05, (byte)0xbd, 0x0e, 0x68, 0x7c, (byte)0xd9, 0x7f, 0x0f, (byte)0xb7 };
str = "\u000e\ufffdo\ufffdc\ufffd\u0005\ufffd\u000eh|\ufffd\u007f\u000f\ufffd";
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x59, (byte)0xaa, 0x1b, 0x1b, 0x71, (byte)0xb4,
  (byte)0xc7, 0x39, (byte)0xc6, (byte)0x99, (byte)0x94, 0x7f, (byte)0x9f,
  0x72, (byte)0xe9, (byte)0xb4, (byte)0x8b, 0x7d, (byte)0x8f, 0x59, 0x01,
  0x65, (byte)0xa2, (byte)0xf6, (byte)0xdb, 0x57, 0x33, 0x60, 0x54, 0x64 };
str =
...
Assert.assertEquals(
 str,
 Encodings.DecodeToString(charset, bytes));
bytes = new byte[] { 0x44, (byte)0xaf, (byte)0xe4, 0x2f, (byte)0xff, 0x22,
...
ICharacterEncoding charset = Encodings.GetEncoding("euc-jp");
str = "\uff11\u7377\u7e6a";
bytes = new byte[] { (byte)0xa3, (byte)0xb1, (byte)0xfb, (byte)0xa4,
  (byte)0xe5, (byte)0xe9 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u7546\u591b\u52df";
bytes = new byte[] { (byte)0xe1, (byte)0xbc, (byte)0xd4, (byte)0xec,
  (byte)0xca, (byte)0xe7 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u8515\uffe4\u5f27\uff8c";
bytes = new byte[] { (byte)0xe8, (byte)0xf8, (byte)0xfc, (byte)0xfc,
  (byte)0xb8, (byte)0xcc, (byte)0x8e, (byte)0xcc };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u5922\u7dd2\u7149\u7594\uff68\u750e";
bytes = new byte[] { (byte)0xcc, (byte)0xb4, (byte)0xbd, (byte)0xef,
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u2175\u5830\u6d74\uff12";
bytes = new byte[] { (byte)0xfc, (byte)0xf6, (byte)0xb1, (byte)0xe1,
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u7b02\uff21\u6863";
bytes = new byte[] { (byte)0xe3, (byte)0xf3, (byte)0xa3, (byte)0xc1,
  (byte)0xdb, (byte)0xe3 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u8de3\uff16\u8b10";
bytes = new byte[] { (byte)0xec, (byte)0xf1, (byte)0xa3, (byte)0xb6,
  (byte)0xeb, (byte)0xed };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff71\u60d8\u5dba";
bytes = new byte[] { (byte)0x8e, (byte)0xb1, (byte)0xd8, (byte)0xb1,
  (byte)0xce, (byte)0xe6 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u223d\uff04\uff82";
bytes = new byte[] { (byte)0xa2, (byte)0xe6, (byte)0xa1, (byte)0xf0,
  (byte)0x8e, (byte)0xc2 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff75;\uff8b";
bytes = new byte[] { (byte)0x8e, (byte)0xb5, 0x3b, (byte)0x8e, (byte)0xcb };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff18\u8ed2\uff19\u58df";
bytes = new byte[] { (byte)0xa3, (byte)0xb8, (byte)0xb8, (byte)0xae,
  (byte)0xa3, (byte)0xb9, (byte)0xd4, (byte)0xe2 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u641c\uff69\uff07";
bytes = new byte[] { (byte)0xd9, (byte)0xd3, (byte)0x8e, (byte)0xa9,
  (byte)0xfc, (byte)0xfd };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u822b\uff88\u688f";
bytes = new byte[] { (byte)0xe7, (byte)0xd6, (byte)0x8e, (byte)0xc8,
  (byte)0xdb, (byte)0xe7 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u7696\u60e0\uff13";
bytes = new byte[] { (byte)0xe2, (byte)0xaa, (byte)0xd8, (byte)0xaa,
  (byte)0xa3, (byte)0xb3 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\uff5d\uff5a\uff65";
bytes = new byte[] { (byte)0xa1, (byte)0xd1, (byte)0xa3, (byte)0xfa,
  (byte)0x8e, (byte)0xa5 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u9724\uff35\u59d4";
bytes = new byte[] { (byte)0xf0, (byte)0xc5, (byte)0xa3, (byte)0xd5,
  (byte)0xb0, (byte)0xd1 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\uff7c\uff78\u69d9\uff43\uff51";
bytes = new byte[] { (byte)0x8e, (byte)0xbc, (byte)0x8e, (byte)0xb8,
  (byte)0xcb, (byte)0xea, (byte)0xa3, (byte)0xe3, (byte)0xa3, (byte)0xf1 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff0a\u542c\u539f\uff3a\uff3d";
bytes = new byte[] { (byte)0xa1, (byte)0xf6, (byte)0xd2, (byte)0xe1,
  (byte)0xb8, (byte)0xb6, (byte)0xa3, (byte)0xda, (byte)0xa1, (byte)0xcf };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u0015";
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u630c\u7985\u2502";
bytes = new byte[] { (byte)0xd9, (byte)0xc8, (byte)0xc1, (byte)0xb5,
  (byte)0xa8, (byte)0xa2 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "l\uff8f\u55fd";
bytes = new byte[] { 0x6c, (byte)0x8e, (byte)0xcf, (byte)0xd3, (byte)0xd6 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u601c\uff0b";
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\uff2f\u9f76\u7345\uff67";
bytes = new byte[] { (byte)0xa3, (byte)0xcf, (byte)0xf3, (byte)0xfb,
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u5291\u719f\u6a44";
bytes = new byte[] { (byte)0xd1, (byte)0xfd, (byte)0xbd, (byte)0xcf,
  (byte)0xdc, (byte)0xed };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u67deg\u7bdd";
bytes = new byte[] { (byte)0xdb, (byte)0xd0, 0x67, (byte)0xe4, (byte)0xc0 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u518f\uff5c";
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\uff12\u9a62\u786c\u5dbc";
bytes = new byte[] { (byte)0xa3, (byte)0xb2, (byte)0xf1, (byte)0xe6,
  (byte)0xb9, (byte)0xc5, (byte)0xd6, (byte)0xd9 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff42\u67d3\uff0b";
bytes = new byte[] { (byte)0xa3, (byte)0xe2, (byte)0xc0, (byte)0xf7,
  (byte)0xa1, (byte)0xdc };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\uff9e\uff24\uff64";
bytes = new byte[] { (byte)0x8e, (byte)0xde, (byte)0xa3, (byte)0xc4,
  (byte)0x8e, (byte)0xa4 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u6e4a\uff4a\uff55";
bytes = new byte[] { (byte)0xcc, (byte)0xab, (byte)0xa3, (byte)0xea,
  (byte)0xa3, (byte)0xf5 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u6e29\u983c\uff1d";
bytes = new byte[] { (byte)0xb2, (byte)0xb9, (byte)0xcd, (byte)0xea,
  (byte)0xa1, (byte)0xe1 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u5de8\u72c4\u5055";
bytes = new byte[] { (byte)0xb5, (byte)0xf0, (byte)0xe0, (byte)0xbf,
  (byte)0xd0, (byte)0xf3 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u615f\uff34\u8e59";
bytes = new byte[] { (byte)0xd8, (byte)0xd6, (byte)0xa3, (byte)0xd4,
  (byte)0xed, (byte)0xa6 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u732a\u71e7\u5f66";
bytes = new byte[] { (byte)0xc3, (byte)0xf6, (byte)0xdf, (byte)0xfc,
  (byte)0xc9, (byte)0xa7 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u9397\u6bb7\u553e";
bytes = new byte[] { (byte)0xc1, (byte)0xf9, (byte)0xdd, (byte)0xd6,
  (byte)0xc2, (byte)0xc3 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\uff14\uff8d\uff58";
bytes = new byte[] { (byte)0xa3, (byte)0xb4, (byte)0x8e, (byte)0xcd,
  (byte)0xa3, (byte)0xf8 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u6afa\u7b6c\uff5b\uff0b";
bytes = new byte[] { (byte)0xdd, (byte)0xb2, (byte)0xe4, (byte)0xad,
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u9ed9\u6bd8\uff61";
bytes = new byte[] { (byte)0xcc, (byte)0xdb, (byte)0xc8, (byte)0xfb,
  (byte)0x8e, (byte)0xa1 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\uff42\uff7d\u670f";
bytes = new byte[] { (byte)0xa3, (byte)0xe2, (byte)0x8e, (byte)0xbd,
  (byte)0xdb, (byte)0xac };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u5039\uff51\u5046\uff45\u585e";
bytes = new byte[] { (byte)0xb7, (byte)0xf0, (byte)0xa3, (byte)0xf1,
  (byte)0xf9, (byte)0xbd, (byte)0xa3, (byte)0xe5, (byte)0xba, (byte)0xc9 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u7c95\u542d";
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\uff7d\u54a4\u73e3";
bytes = new byte[] { (byte)0x8e, (byte)0xbd, (byte)0xd3, (byte)0xa3,
  (byte)0xfb, (byte)0xa8 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff02\uff6cT";
bytes = new byte[] { (byte)0xfc, (byte)0xfe, (byte)0x8e, (byte)0xac, 0x54 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u592a\u75e2\uff10";
bytes = new byte[] { (byte)0xc2, (byte)0xc0, (byte)0xce, (byte)0xa1,
  (byte)0xa3, (byte)0xb0 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u64fe\u7370\uff30";
bytes = new byte[] { (byte)0xbe, (byte)0xf1, (byte)0xe0, (byte)0xd8,
  (byte)0xa3, (byte)0xd0 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u66c9\u6a8d\uff8d";
bytes = new byte[] { (byte)0xda, (byte)0xfc, (byte)0xdc, (byte)0xfa,
  (byte)0x8e, (byte)0xcd };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\uff1d\uffe2\u68fa";
bytes = new byte[] { (byte)0xa1, (byte)0xe1, (byte)0xa2, (byte)0xcc,
  (byte)0xb4, (byte)0xbd };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff8f\uff4e\uff96\u5e4c\u787c";
bytes = new byte[] { (byte)0x8e, (byte)0xcf, (byte)0xa3, (byte)0xee,
  (byte)0x8e, (byte)0xd6, (byte)0xcb, (byte)0xda, (byte)0xe2, (byte)0xef };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff06\u91cb\u96f2\u6625";
bytes = new byte[] { (byte)0xa1, (byte)0xf5, (byte)0xee, (byte)0xd9,
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u222e\uff05\uff8e";
bytes = new byte[] { (byte)0xad, (byte)0xf3, (byte)0xa1, (byte)0xf3,
  (byte)0x8e, (byte)0xce };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u75d5\u2116\uff84\uff74\u5040";
bytes = new byte[] { (byte)0xba, (byte)0xaf, (byte)0xad, (byte)0xe2,
  (byte)0x8e, (byte)0xc4, (byte)0x8e, (byte)0xb4, (byte)0xf9, (byte)0xb9 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u697d\uff54\uff27\uff66";
bytes = new byte[] { (byte)0xb3, (byte)0xda, (byte)0xa3, (byte)0xf4,
  (byte)0xa3, (byte)0xc7, (byte)0x8e, (byte)0xa6 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u6d9b\uff2b\uff3b";
bytes = new byte[] { (byte)0xc5, (byte)0xf3, (byte)0xa3, (byte)0xcb,
  (byte)0xa1, (byte)0xce };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff87\u628a\uff05";
bytes = new byte[] { (byte)0x8e, (byte)0xc7, (byte)0xc7, (byte)0xc4,
  (byte)0xa1, (byte)0xf3 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u66dc\u5468\uff55";
bytes = new byte[] { (byte)0xcd, (byte)0xcb, (byte)0xbc, (byte)0xfe,
  (byte)0xa3, (byte)0xf5 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u6e56\u51aa\uff14";
bytes = new byte[] { (byte)0xb8, (byte)0xd0, (byte)0xd1, (byte)0xd1,
  (byte)0xa3, (byte)0xb4 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u9bb9\u6bbb\u88b0";
bytes = new byte[] { (byte)0xf2, (byte)0xc3, (byte)0xb3, (byte)0xcc,
  (byte)0xea, (byte)0xde };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u5e2d\u5a40\u6350";
bytes = new byte[] { (byte)0xc0, (byte)0xca, (byte)0xd5, (byte)0xb4,
  (byte)0xd9, (byte)0xd0 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "[\uff68\uff47";
bytes = new byte[] { 0x5b, (byte)0x8e, (byte)0xa8, (byte)0xa3, (byte)0xe7 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff03\uff32\u7fc5";
bytes = new byte[] { (byte)0xa1, (byte)0xf4, (byte)0xa3, (byte)0xd2,
  (byte)0xe6, (byte)0xc2 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u7d20\u644e\u5902";
bytes = new byte[] { (byte)0xc1, (byte)0xc7, (byte)0xd9, (byte)0xf7,
  (byte)0xd4, (byte)0xe9 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u6ec5\u800c\uff61\uff56";
bytes = new byte[] { (byte)0xcc, (byte)0xc7, (byte)0xbc, (byte)0xa9,
  (byte)0x8e, (byte)0xa1, (byte)0xa3, (byte)0xf6 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\uff34\uff76\u5712";
bytes = new byte[] { (byte)0xa3, (byte)0xd4, (byte)0x8e, (byte)0xb6,
  (byte)0xb1, (byte)0xe0 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
str = "\u7005\u75a3\u9b22";
bytes = new byte[] { (byte)0xfa, (byte)0xf1, (byte)0xe1, (byte)0xcf,
  (byte)0xf2, (byte)0xa6 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
...
TestCommon.AssertByteArraysEqual(
  ...
  Encodings.EncodeToBytes(str, charset));
str = "\u6657\u7d71\u67ff";
bytes = new byte[] { (byte)0xfa, (byte)0xbc, (byte)0xc5, (byte)0xfd,
  (byte)0xb3, (byte)0xc1 };
TestCommon.AssertByteArraysEqual(
  bytes,
  Encodings.EncodeToBytes(str, charset));
