...
import com.upokecenter.text.*;
  ...
  public class KoreanEUCTest {
    ...
    public void TestKoreanEUCDecoder() {
      ...
      bytes = new byte[] {
        0x65, 0x5f, 0x16, 0x47, (byte)0x83, (byte)0xf4,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x20, (byte)0xa8, 0x47, 0x47, (byte)0x80, (byte)0xc3,
  ...
  "\u0020\ucb73G\ufffd\ud691Y\ufffds%\u001at\uce63N\ufffdQ:\u81ed\ucf6e\ufffd\ubf82";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x2e, 0x5d, (byte)0xbc, (byte)0xbb, (byte)0xc5, 0x1b,
  ...
  ".]\uc136\ufffd\u001b\u0013\ufffdC\ufffd\ufffd\u0011\uac8a\ufffd\u001b\ufffd";
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x7a, 0x23, (byte)0xdb, 0x7c, (byte)0xb1, (byte)0xa2,
  ...
  "\ufffd\u0007\ufffdg\u6e36\ufffd\u001c\u4f433%\uc587\u000c\u001eK\ufffdAwPb\u000cIB\ube30\uad8d";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x14, (byte)0x87, 0x68, 0x43, 0x5a, 0x28, 0x42, 0x63,
  ...
  "\u0014\ub1c0CZ(Bc\u0008R\ub782\u001e\u65b0b\ufffdc@\ufffd/\uc5cd\ufffd/*Q";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x94, 0x33, 0x10, 0x7f, 0x2c, 0x5f, 0x37,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xf8, (byte)0xa2, 0x40, (byte)0xc3, 0x6d, 0x52,
...
"\u516b@\ud672R'!\u0020\uc554\ufffdY\ufffdj\ufffdMF\ufffd\"\ud623SN";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x42, (byte)0xd4, 0x48, (byte)0xcd, 0x24, 0x61, 0x64,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xc0, (byte)0xe9, 0x53, (byte)0xe3, 0x73, 0x6e,
  ...
  "\uc7b0S\ufffdsn\ub6db\ufffd5\ufffd+n\ufffdrgA\ufffd)\ufffd\ufffdx\ufffdzz";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x5a, 0x12, (byte)0xde, 0x22, 0x71, (byte)0xe8, 0x28,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x5d, 0x3e, (byte)0xae, 0x35, (byte)0xf7, 0x38,
  ...
  "]>\ufffd5\ufffd8\uccac\ufffd\u007fm\ufffd\\\u0008\ufffd\ufffd\u001d0Z\ufffd\u0005\u201d";
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xea, 0x73, (byte)0xe6, 0x13, (byte)0xd7,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x71, (byte)0x8c, 0x34, (byte)0xa4, 0x1b, 0x11,
        (byte)0xb4, 0x2c,
       };
      str = "q\ufffd4\ufffd\u001b\u0011\ufffd\u002c";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x13, 0x0b, (byte)0xeb, (byte)0x84, 0x3e, 0x40, 0x60,
  ...
  "\u0013\u000b\ufffd>@`\ufffdT\uad38\u0015\u007b\ufffdQ!\ufffd0\ufffd\uc38dk\ufffd>\ubc98";
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x66, (byte)0xd8, (byte)0xab, 0x2c, 0x62, 0x55, 0x0e,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xb3, (byte)0x95, (byte)0x8e, 0x6f, 0x74, 0x4e,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xf9, 0x6e, 0x70, (byte)0xc8, (byte)0x87,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xce, 0x53, 0x5f, (byte)0xea, 0x7b, (byte)0xfc,
        0x2e,
       };
      str = "\ufffdS_\ufffd\u007b\ufffd.";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x38, (byte)0xdd, 0x0a, (byte)0xd6, 0x22, (byte)0xbc,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x91, 0x2a, 0x30, 0x47, (byte)0x8c, 0x4b, 0x24,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x7e, (byte)0x8f, 0x5b, 0x23, 0x40, 0x6e, (byte)0x87,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xd9, (byte)0xeb, 0x23, (byte)0x94, (byte)0xd3,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x56, (byte)0xb2, 0x3c, (byte)0x87, 0x12, (byte)0xc5,
  ...
  "V\ufffd<\ufffd\u0012\ud748\ub61eM_\ufffd5\ufffd*\u001e\u6b777>\uc7efsb[`\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xe9, (byte)0xdd, 0x29, (byte)0x92, 0x78, 0x39,
        (byte)0x9e, 0x1f,
       };
      str = "\u76c2)\ubb6f9\ufffd\u001f";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x83, (byte)0xfb, (byte)0x86, (byte)0x81,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xb9, 0x56, 0x4d, 0x36, 0x2b, 0x19, (byte)0xc0,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x34, 0x06, 0x1a, 0x6f, (byte)0xd3, 0x3d, 0x6e, 0x5c,
        (byte)0xc0,
       };
      str = "4\u0006\u001ao\ufffd\u003dn\\\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x70, 0x0f, 0x62, 0x5e, 0x44, (byte)0x9f, 0x5c,
        0x0a,
       };
      str = "p\u000fb^D\ufffd\\\n";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x7c, (byte)0xcb, 0x36, 0x67, (byte)0xf1, 0x24,
  ...
  "|\ufffd6g\ufffd$\uc8a9\u0016-\ub5e7\ubacc8O\ufffd+\ufffd\u0008\u0017\ub1f3";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xcd, 0x22, 0x40, 0x79, 0x5c, (byte)0xc0, 0x38,
        0x53, 0x72, 0x7a,
       };
      str = "\ufffd\"@y\\\ufffd8Srz";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x57, 0x5b, 0x74, 0x34, 0x25, 0x3e, 0x3f, (byte)0x8a,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x57, (byte)0xbe, (byte)0xde, 0x75, 0x76, 0x27,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x9a, 0x30, (byte)0xb5, (byte)0xaa, 0x16, 0x5a,
...
"\ufffd0\ub381\u0016Z\ufffd\u000f7Y\ufffd\u001d\uba63\u000ePh)}\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xa9, (byte)0x86, 0x7c, (byte)0x83, (byte)0xe5,
  ...
  "\ucc02|\uaec3Y]\ufffd\u0005\u8755\u0005\ub1b8\ufffd+\ub341k\ufffdk\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x87, 0x66, 0x44, (byte)0xf9, 0x03, (byte)0xd7,
...
"\ub1beD\ufffd\u0003\ufffd\u0015\uc4d4\ufffd;vK\u0004\u001b\ufffdI\ufffd";
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xc0, (byte)0x90, (byte)0xc6, (byte)0xfb, 0x21,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x4e, (byte)0xad, 0x5c, 0x17, 0x34, (byte)0xf5, 0x14,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xe9, 0x48, (byte)0xe6, 0x77, 0x2c, (byte)0xef,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x6c, 0x2d, 0x18, (byte)0xb6, 0x7f, 0x0d, 0x44,
  ...
  "l-\u0018\ufffd\u007f\rD\ub7b9K.\u0007\ud673/\ufffd\u0016\ucc36A\u0006\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xf8, 0x49, (byte)0xe8, 0x46, (byte)0xf1,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x57, 0x4f, 0x53, (byte)0xf2, 0x6f, 0x3b, (byte)0xe5,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x68, 0x32, (byte)0xb8, 0x4a, 0x20, (byte)0xbe,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xc5, 0x6e, 0x5b, 0x02, (byte)0x9d, (byte)0x93,
  ...
  "\ud74b[\u0002\uc4f6\ubb10n\ufffd\u0002f\u6cbf\ufffd9.q\ufffd\n&x\ud60b\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x92, 0x6c, 0x1b, 0x31, (byte)0xd4, (byte)0x87,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x79, (byte)0xff, 0x51, 0x54, 0x58, (byte)0x86, 0x47,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x4c, 0x3a, (byte)0x90, (byte)0xca, (byte)0xb2, 0x57,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x5c, (byte)0x9e, 0x6b, (byte)0xf4, (byte)0xfa,
        (byte)0xe0, 0x4b,
       };
      str = "\\\uc5d2\u54e8\ufffdK";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x37, (byte)0xce, (byte)0xfc, (byte)0xdf, (byte)0xe4,
...
"7\u4ff1\u8272Te\ufffd\"\\\ufffdq\u0014\"\u68f2)\u000f\u001d\ud713\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xc2, 0x17, (byte)0xf1, 0x0b, 0x0c, (byte)0xf1,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xc5, 0x67, 0x67, (byte)0xe1, (byte)0xb4,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x2e, 0x77, (byte)0x9e, 0x16, 0x7f, (byte)0xdc,
  ...
  ".w\ufffd\u0016\u007f\u5831jQ%89\ufffdV\u7e47&/\u000f8\u0011\ufffdue\ufffd5G\ufffd";
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x6a, 0x3a, 0x7a, 0x5c, (byte)0x8a, 0x2b, 0x4d, 0x5a,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x1a, 0x6c, 0x0d, (byte)0xf6, (byte)0xf2, 0x3f,
        (byte)0xee, 0x48, (byte)0xe7, 0x3d, 0x2f, (byte)0xf3, 0x57, (byte)0xfd,
        (byte)0xc5, 0x55, (byte)0xda, 0x6d, 0x26, (byte)0xa4, 0x30,
        (byte)0xb6,
       };
      str =
"\u001al\r\u5544?\ufffdH\ufffd\u003d/\ufffdW\u5fbdU\ufffdm&\ufffd0\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x6d, 0x2b, 0x2a, 0x02, 0x09, (byte)0xd2, (byte)0xa1,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x70, (byte)0xd4, 0x78, 0x6e, 0x48, 0x6a, 0x62, 0x0b,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x77, 0x04, 0x0a, (byte)0xad, 0x3f, (byte)0xa1,
        (byte)0x95,
       };
      str = "w\u0004\n\ufffd?\uc8fb";
      Assert.assertEquals (
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xc0, 0x78, 0x6d, 0x7e, (byte)0xb8, 0x32, 0x22,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x66, (byte)0x9b, 0x57, 0x0f, (byte)0x92, 0x3d,
  ...
  "f\uc32f\u000f\ufffd\u003d\ufffd2\ucb2b\ucb9a\ufffd\u001e\u001e6q\ubdfe\ufffd3OT\nR\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x20, 0x51, 0x39, 0x62, (byte)0x82, 0x53, (byte)0xfa,
        0x1b, 0x4f,
       };
      str = "\u0020Q9b\uad2a\ufffd\u001bO";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x65, 0x4c, (byte)0xe2, 0x74, 0x31, (byte)0xa5, 0x00,
  ...
  "eL\ufffdt1\ufffd\u0000>YBb\ufffd\u007be6\u000bj\ufffd\u0009&\ufffd:wp\ufffdd1\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x9c, (byte)0x98, (byte)0xef, 0x38, (byte)0xb0,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x07, 0x5f, 0x47, 0x4e, 0x75, 0x7a, 0x6b, 0x1f,
  ...
  "\u0007_GNuzk\u001f\ufffd\\\u003d)K`\ufffd*\u002c\u0020\u3213gc\ufffd?~\uba121";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xb1, (byte)0xab, (byte)0xbe, 0x52, 0x25,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x98, 0x1c, 0x77, 0x70, (byte)0xec, 0x61, 0x36,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xb9, 0x3e, 0x48, 0x49, 0x5b, (byte)0x92, 0x34,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x54, 0x74, (byte)0xf4, 0x1c, 0x77, 0x18, (byte)0xa5,
  ...
  "Tt\ufffd\u001cw\u0018\ufffd\u000b\ucbbd\ufffd(\ufffdz\ufffd#&nMG\ufffdFH6s\u0013";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xec, 0x32, 0x40, (byte)0xf8, (byte)0x8b,
        (byte)0x8b, 0x19, 0x26,
       };
      str = "\ufffd2@\ufffd\ufffd\u0019&";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x66, (byte)0x89, (byte)0x94, (byte)0xf5, 0x1a, 0x28,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xbb, (byte)0xef, (byte)0x92, (byte)0xc4,
        (byte)0xc8, (byte)0xce, (byte)0xe0, 0x48, 0x5e, (byte)0xee,
        (byte)0xba,
       };
      str = "\uc0bc\ubbbd\ud6e8\ufffdH^\u5480";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x63, 0x48, 0x60, (byte)0x87, (byte)0xf4, (byte)0x83,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x6d, 0x05, 0x55, 0x6b, (byte)0xb2, 0x45, 0x0f,
  ...
  "m\u0005Uk\ucf73\u000f\ufffd9[0O\ufffd\u000b\u6142f$\u000f\ufffdN\u5ef3\u002c!\ub10d`";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x68, 0x44, 0x3e, 0x24, 0x4e, 0x4a, 0x6a, (byte)0xb0,
  ...
  "hD>$NJj\ufffd)2i\ufffd!i\ub1c4G\uc1e2\ufffd\u001d&\uc6fa\u002c\u001fg\ufffdC\ufffd";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x67, 0x02, 0x2c, 0x50, 0x73, (byte)0xda, (byte)0xcf,
...
"g\u0002\u002cPs\u535aYx(r\uca1ft\ub5dcU\ufffdQ\ufffd'v\u2503\u8941Hn";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x20, 0x61, 0x4c, 0x3e, 0x2e, 0x54, (byte)0x88, 0x29,
...
"\u0020aL>.T\ufffd)Q\u84c0\uf995\ufffd\u001e|\ufffdh\u83c5jU\ufffdA";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xcc, 0x1e, 0x00, (byte)0x82, (byte)0xd8, 0x4d,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xd1, (byte)0xb1, 0x7d, 0x1b, 0x2b, 0x41, 0x66,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x8a, 0x1b, (byte)0xa2, (byte)0xff, (byte)0xd2,
        0x09,
       };
      str = "\ufffd\u001b\ufffd\ufffd\u0009";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x7e, (byte)0xe4, 0x31, 0x70, 0x53, (byte)0xbe,
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0x94, (byte)0xcc, 0x48, (byte)0xa6, (byte)0xcd,
  ...
  "\ubd9bH\u2526\ufffdC\u0020SD\ufffd\u001fn><\ub1a8\ufffd~\u001a\ufffdXf\u0012";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x39, 0x54, (byte)0xa5, 0x67, (byte)0xc9, (byte)0x95,
  ...
  "9T\uca71\ufffdr\ufffd:\u4e03\ufffd]\ufffd\ud29e\u88fd\"#m\uc928`\u007b\u007b";
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x36, 0x6e, 0x2c, 0x58, 0x1a, 0x6b, (byte)0xfa, 0x0c,
        (byte)0x9c, (byte)0xeb,
       };
      str = "6n\u002cX\u001ak\ufffd\u000c\uc495";
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        0x44, 0x40, 0x55, 0x15, 0x36, (byte)0xd5, 0x73,
        (byte)0x8e, (byte)0xd8, 0x52, 0x23, 0x7d, 0x32, 0x44, (byte)0xf1,
        0x61,
       };
      str = "D@U\u00156\ufffds\ub854R#}2D\ufffda";
      Assert.assertEquals (
      ...
      Assert.assertEquals (
        ...
        Encodings.DecodeToString(charset, bytes));
      bytes = new byte[] {
        (byte)0xa2, (byte)0xdd, 0x68, 0x15, (byte)0xfa, 0x4b,
    ...
    public void TestKoreanEUCEncoder() {
      ...
      str = "\u7a2e\uff44\u2531";
      bytes = new byte[] {
        (byte)0xf0, (byte)0xfa, (byte)0xa3, (byte)0xe4,
        (byte)0xa6, (byte)0xd3,
       };
      ...
      str = "\u5e1d\u7518\u250d";
      bytes = new byte[] {
        (byte)0xf0, (byte)0xa8, (byte)0xca, (byte)0xf6,
        (byte)0xa6, (byte)0xc8,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u58d3\uff55\ucf73";
      bytes = new byte[] {
        (byte)0xe4, (byte)0xe2, (byte)0xa3, (byte)0xf5,
        (byte)0xb2, 0x45,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u6043\ucc23\u5553";
      bytes = new byte[] {
        (byte)0xe3, (byte)0xbe, (byte)0xa9, (byte)0x9f,
        (byte)0xcc, (byte)0xf6,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uff28\uc928\uadb9";
      bytes = new byte[] {
        (byte)0xa3, (byte)0xc8, (byte)0xa2, 0x57, (byte)0x82,
        (byte)0xca,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uafbf\ubbde\u5b6b";
      bytes = new byte[] {
        (byte)0x85, 0x41, (byte)0x92, (byte)0xe0, (byte)0xe1,
        (byte)0xdd,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uff03\uff14\u7ae5";
      bytes = new byte[] {
        (byte)0xa3, (byte)0xa3, (byte)0xa3, (byte)0xb4,
        (byte)0xd4, (byte)0xdb,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "]\u2511\ubda7";
      bytes = new byte[] {
        0x5d, (byte)0xa6, (byte)0xc2, (byte)0x94,
        (byte)0xd6,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u775b\u7901\u7fc1\uc64c";
      bytes = new byte[] {
        (byte)0xef, (byte)0xec, (byte)0xf5, (byte)0xa7,
      ...
      str = "\uc3c7\uff45\u25b6\u6746";
      bytes = new byte[] {
        (byte)0x9b, (byte)0xed, (byte)0xa3, (byte)0xe5,
      ...
      str = "\u7e93+\uff50";
      bytes = new byte[] {
        (byte)0xe7, (byte)0xc5, 0x2b, (byte)0xa3,
        (byte)0xf0,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uff35\uff3f\u88fd\uff01\u7554";
      bytes = new byte[] {
        (byte)0xa3, (byte)0xd5, (byte)0xa3, (byte)0xdf,
        (byte)0xf0, (byte)0xb2, (byte)0xa3, (byte)0xa1, (byte)0xda,
        (byte)0xed,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u2193\ubd32\uff07";
      bytes = new byte[] {
        (byte)0xa1, (byte)0xe9, (byte)0x94, 0x73, (byte)0xa3,
        (byte)0xa7,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u7db1w\u79d5";
      bytes = new byte[] {
        (byte)0xcb, (byte)0xb5, 0x77, (byte)0xdd,
        (byte)0xf9,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uff52\u7d04\u6b61";
      bytes = new byte[] {
        (byte)0xa3, (byte)0xf2, (byte)0xe5, (byte)0xb3,
        (byte)0xfc, (byte)0xb6,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u0005\u2468\uff26";
      bytes = new byte[] {
        0x05, (byte)0xa8, (byte)0xef, (byte)0xa3,
        (byte)0xc6,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uc285\uffe1\u2534\uff2c";
      bytes = new byte[] {
        (byte)0x9a, (byte)0x97, (byte)0xa1, (byte)0xcc,
      ...
      str = "\u5fb5\ud73f\u792b";
      bytes = new byte[] {
        (byte)0xf3, (byte)0xa3, (byte)0xc5, 0x65, (byte)0xd5,
        (byte)0xf8,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u6b78\u7dde\uff43\u6c90";
      bytes = new byte[] {
        (byte)0xcf, (byte)0xfd, (byte)0xd3, (byte)0xb0,
      ...
      str = "\u6a53\ub6e6\u6cbb";
      bytes = new byte[] {
        (byte)0xe2, (byte)0xe5, (byte)0x8d, 0x69, (byte)0xf6,
        (byte)0xbd,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u7d76\u501f\ud25d";
      bytes = new byte[] {
        (byte)0xef, (byte)0xbe, (byte)0xf3, (byte)0xa8,
        (byte)0xb9, 0x70,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uff1d\u7d44\u7130";
      bytes = new byte[] {
        (byte)0xa3, (byte)0xbd, (byte)0xf0, (byte)0xda,
        (byte)0xe6, (byte)0xfb,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u659c\u7729\u7430";
      bytes = new byte[] {
        (byte)0xde, (byte)0xd8, (byte)0xfa, (byte)0xdf,
        (byte)0xe6, (byte)0xfc,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uff34\uc8a5\uff15";
      bytes = new byte[] {
        (byte)0xa3, (byte)0xd4, (byte)0xa1, 0x41, (byte)0xa3,
        (byte)0xb5,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u62cf\u619a\u56bc";
      bytes = new byte[] {
        (byte)0xd1, (byte)0xd9, (byte)0xf7, (byte)0xa6,
        (byte)0xed, (byte)0xc4,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u5d0d\uff22\uff43";
      bytes = new byte[] {
        (byte)0xd5, (byte)0xcf, (byte)0xa3, (byte)0xc2,
        (byte)0xa3, (byte)0xe3,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u7bc0\u254b\uff34\u246c\uff2b\u2116";
      bytes = new byte[] {
        (byte)0xef, (byte)0xbd, (byte)0xa6, (byte)0xb6,
      ...
      str = "\u7d2e\u7be9\u59ee";
      bytes = new byte[] {
        (byte)0xf3, (byte)0xcf, (byte)0xde, (byte)0xe8,
        (byte)0xf9, (byte)0xf3,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uff27\u6aa2\u69ff\u7f75\u69b4\u5e63\u0001";
      bytes = new byte[] {
        (byte)0xa3, (byte)0xc7, (byte)0xcb, (byte)0xfe,
      ...
      str = "\u6258\u7530\u6817";
      bytes = new byte[] {
        (byte)0xf6, (byte)0xf5, (byte)0xef, (byte)0xa3,
        (byte)0xd7, (byte)0xca,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\ucdf0\uffe1\u5dde";
      bytes = new byte[] {
        (byte)0xc3, (byte)0xed, (byte)0xa1, (byte)0xcc,
        (byte)0xf1, (byte)0xb6,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u7d93\uff54\uffe5";
      bytes = new byte[] {
        (byte)0xcc, (byte)0xe8, (byte)0xa3, (byte)0xf4,
        (byte)0xa1, (byte)0xcd,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uc17bG\u253f\ub05d";
      bytes = new byte[] {
        (byte)0x99, 0x7a, 0x47, (byte)0xa6, (byte)0xbb,
        (byte)0xb3, (byte)0xa1,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u7d1a\u6dde\u78bb\u57ce";
      bytes = new byte[] {
        (byte)0xd0, (byte)0xe4, (byte)0xe1, (byte)0xe7,
      ...
      str = "\u7e6b\u2663\uff09";
      bytes = new byte[] {
        (byte)0xcd, (byte)0xa8, (byte)0xa2, (byte)0xc0,
        (byte)0xa3, (byte)0xa9,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uce03\ub201\ub45a";
      bytes = new byte[] {
        (byte)0xae, (byte)0x81, (byte)0x87, (byte)0xa2,
        (byte)0x8a, 0x52,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\ub31a\u8b2b\uff4c\uaf8a+";
      bytes = new byte[] {
        (byte)0x88, (byte)0xbe, (byte)0xee, (byte)0xe3,
      ...
      str = "\u58ae\u2475\u007b";
      bytes = new byte[] {
        (byte)0xf6, (byte)0xe5, (byte)0xa9, (byte)0xe8,
        0x7b,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u5eb8\ub7fd\ub348";
      bytes = new byte[] {
        (byte)0xe9, (byte)0xbc, (byte)0xb7, (byte)0xb4,
        (byte)0x88, (byte)0xeb,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uff0b\u73c9\uff58";
      bytes = new byte[] {
        (byte)0xa3, (byte)0xab, (byte)0xda, (byte)0xc8,
        (byte)0xa3, (byte)0xf8,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uff1e\u7b9a\u2170";
      bytes = new byte[] {
        (byte)0xa3, (byte)0xbe, (byte)0xf3, (byte)0xb0,
        (byte)0xa5, (byte)0xa1,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u000c\u201c\u6234b";
      bytes = new byte[] {
        0x0c, (byte)0xa1, (byte)0xb0, (byte)0xd3, (byte)0xe3,
        0x62,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\uff04\ub74d\u5b97";
      bytes = new byte[] {
        (byte)0xa3, (byte)0xa4, (byte)0x8d, (byte)0xc5,
        (byte)0xf0, (byte)0xf3,
       };
      TestCommon.AssertByteArraysEqual (
        bytes,
      ...
      str = "\u5ed0\u5a18\uff04\uaf65";
      bytes = new byte[] {
        (byte)0xcf, (byte)0xaa, (byte)0xd2, (byte)0xa6,
